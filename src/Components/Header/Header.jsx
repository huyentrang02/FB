...
import './Header.css'
import {  faSearch, faBell, faTh, faComments, faHome, faFlag, faSortDown, faUserFriends, faLaptopCode, faArrowLeft, faTimes, faLongArrowAltLeft } from '@fortawesome/free-solid-svg-icons';
